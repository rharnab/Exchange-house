                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">New Customer Creation Report</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-6">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">New Customer Creation Report</h3>
                            </div>

                            <form method="post" action="{{route('admin.new_customer_creation_report_details')}}">
                                @csrf
                                <div class="row p-4">
                                    <div class="col-md-12">
