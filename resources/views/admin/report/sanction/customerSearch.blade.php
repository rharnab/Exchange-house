    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Sanction report of customers</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <form method="GET" action="{{ route('admin.sanction.customer.report.generate') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="type" name="type" required>
                                            ...
                                            <option value="Customer authorize">Customer authorize</option>
