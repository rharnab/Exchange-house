                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($data as $customer)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                $accounts = App\Models\AccountOpening::where('id',$customer->operation_id)->get();
                                            @endphp
                                            @foreach($accounts as $account)
                                                @php
                                                    $customers = App\Models\CustomerInfo::where('id', $account->customer_id)->get();
                                                @endphp
                                        ...
                                        <td>{{ $cusData->sanction_score }}</td>
                                        <td>{{ $cusData->sanction_score_auth }}</td>
                                        <td>{{ $cusData->sanction_table }}</td>
                                        <td>{{ $cusData->sanction_remarks }}</td>
