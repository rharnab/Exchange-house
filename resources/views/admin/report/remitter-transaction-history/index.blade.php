...
@section('title') Remitter Transaction History  @endsection
@section('report')has-treeview menu-open @endsection

@section('remitter_transaction_history') active @endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">  Remitter Transaction History </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.reconcilation-report-details') }}">Home</a></li>
                            <li class="breadcrumb-item active">  Remitter Transaction History </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-6">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">  Remitter Transaction History </h3>
                            </div>

                            <form method="post" action="{{route('admin.remitter-transaction-history-details')}}">
                                @csrf
                                <div class="row p-4">
