...
@section('title') Payment Method Report @endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Payment Method Report</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-default">
                            ...
                            <form method="post" action="{{route('admin.payment_method_wise_report_details')}}">
                                @csrf
                                <div class="row p-4">
                                    <div class="col-md-12">
